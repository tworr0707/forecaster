...
- A Hugging Face token existed in older history and has been scrubbed; if you fork or mirror, re‑scrub history as needed (e.g. `git filter-repo --replace-text <file-with-token>`).
